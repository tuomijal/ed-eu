...
Hospital level: Mean of the responses in a hospital if there were multiple responses from the same hospital

Country level: Mean of the hospital level means

Europe level: Population weighted mean of the country level mean
